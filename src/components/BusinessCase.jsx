export default function BusinessCase() {
  ...
  return (
    <section id="solutions" style={{ padding: "110px 0", background: "#FFFFFF", borderBottom: "1px solid #E2E8F0" }}>
      <div style={{ maxWidth: 1140, margin: "0 auto", padding: "0 24px" }}>
        ...
        {/* 4 Shifts - Structured Editorial Divider Layout */}
        <div style={{
          ...
          <div style={{
            ...
            <span style={{ fontSize: 13.5, fontWeight: 750, color: "#0F172A", letterSpacing: "-.01em" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr" }}>
            {shifts.map((s, i) => (
              <div
                ...
                style={{
                  padding: "28px 32px",
                  borderBottom: i < shifts.length - 1 ? "1px solid #E2E8F0" : "none",
                  display: "grid",
              ...
              >
                <div>
                  ...
                  <div style={{ fontSize: 13, color: "#94A3B8", textDecoration: "line-through", marginBottom: 4 }}>
                    {s.from}
                  </div>
                  <div style={{ fontSize: 16, fontWeight: 750, color: "#0F172A", lineHeight: 1.35 }}>
                    {s.to}
                  </div>
                </div>
        ...
        <div style={{ marginBottom: 80 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 32, flexWrap: "wrap", gap: 16 }}>
            <div>
              ...
              <h3 style={{ fontSize: 24, fontWeight: 800, color: "#0F172A", letterSpacing: "-.015em", margin: 0 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 20 }}>
            {workforceTracks.map((wt, i) => (
              ...
              >
                ...
                <p style={{ fontSize: 13.5, color: "#475569", lineHeight: 1.5, marginBottom: 18 }}>
                  {wt.description}
                </p>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 8, borderTop: "1px solid #E2E8F0", paddingTop: 16 }}>
                  {wt.capabilities.map((cap, idx) => (
                    <div key={idx} style={{ display: "flex", alignItems: "flex-start", gap: 10 }}>
                      <span style={{ color: "#FF8A00", fontSize: 14, lineHeight: "20px" }}>›</span>
                      <span style={{ fontSize: 13, color: "#334155", lineHeight: 1.5 }}>{cap}</span>
                    </div>
                  ))}
                </div>
              </div>
        ...
        {/* Empirical Evidence & Research Benchmarks */}
        <div style={{
          background: "#F8FAFC",
          border: "1px solid #E2E8F0",
          borderRadius: 12,
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 24, flexWrap: "wrap", gap: 12 }}>
            <div>
              <div style={{ fontSize: 11, fontWeight: 700, color: "#1D4ED8", textTransform: "uppercase", letterSpacing: ".08em", marginBottom: 6, fontFamily: "ui-monospace, monospace" }}>
                EMPIRICAL RESEARCH & BENCHMARKS
              </div>
              <div style={{ fontSize: 19, fontWeight: 800, letterSpacing: "-.01em", color: "#0F172A" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 20, marginBottom: 20 }}>
            <div style={{ background: "#FFFFFF", border: "1px solid #E2E8F0", borderRadius: 10, padding: "24px", boxShadow: "0 2px 10px rgba(15,23,42,0.04)" }}>
              <div style={{ fontSize: 32, fontWeight: 900, color: "#1D4ED8", marginBottom: 6, fontFamily: "ui-monospace, monospace" }}>
                ~2 hrs / wk
              </div>
              <div style={{ fontSize: 14, fontWeight: 750, color: "#0F172A", marginBottom: 8 }}>
            ...
            <div style={{ background: "#FFFFFF", border: "1px solid #E2E8F0", borderRadius: 10, padding: "24px", boxShadow: "0 2px 10px rgba(15,23,42,0.04)" }}>
              <div style={{ fontSize: 32, fontWeight: 900, color: "#FF8A00", marginBottom: 6, fontFamily: "ui-monospace, monospace" }}>
                +26.08%
              </div>
              <div style={{ fontSize: 14, fontWeight: 750, color: "#0F172A", marginBottom: 8 }}>
