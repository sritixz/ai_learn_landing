export default function FinalCTA({ onOpenDemo, scrollToSection }) {
  return (
    <section style={{
      ...
      color: "#F0F6FC", padding: "100px 0", textAlign: "center",
      ...
      <div style={{ maxWidth: 880, margin: "0 auto", padding: "0 24px" }}>
        ...
        <div style={{
          ...
          color: "#388BFD", padding: "5px 16px", borderRadius: 999,
          fontSize: 11, fontWeight: 700, textTransform: "uppercase", letterSpacing: ".08em",
          marginBottom: 20, fontFamily: "ui-monospace, monospace"
        }}>
        ...
        <div style={{ display: "flex", justifyContent: "center", gap: 14, marginBottom: 28, flexWrap: "wrap" }}>
          <button
            ...
            style={{
              ...
              padding: "16px 36px", borderRadius: 10, fontWeight: 700,
              fontSize: 15, cursor: "pointer", boxShadow: "0 4px 16px rgba(35, 134, 54, 0.35)",
          ...
          <button
            ...
            style={{
              ...
              padding: "16px 32px", borderRadius: 10, fontWeight: 600,
        ...
        <p style={{ fontSize: 13, color: "#6E7681", fontStyle: "italic", maxWidth: 640, margin: "0 auto" }}>
